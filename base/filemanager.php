...
if (!class_exists('FileManagerClass')) {
    class FileManagerClass
    {
        ...
        public static $sizeSuffixes = array('B', 'KB', 'MB', 'GB', 'TB', 'PB', 'EB', 'ZB', 'YB');
        ...
        public function explor_directory($path)
        {
        }
        ...
        public function explor_files($dir_info)
        {
        ...
        public function get_folder_info($folder, $extra = false)
        {
            $info = array();
            $info['name'] = $folder;
        ...
        public function get_file_info($file, $extra = false)
        {
            $info = array();
            $info['name'] = $file;
            if (is_file($file)) {
